...
namespace Elastic\AppSearch\Test\Unit\Model\Adapter\Engine\Schema;

use Elastic\AppSearch\Model\Adapter\Engine\SchemaProviderInterface;
use Elastic\AppSearch\Model\Adapter\Engine\Schema;
use Elastic\AppSearch\Model\Adapter\Engine\SchemaInterface;
use Elastic\AppSearch\Model\Adapter\Engine\Schema\Builder as SchemaBuilder;
use Elastic\AppSearch\Model\Adapter\Engine\Schema\CompositeSchemaProvider;

/**
 * Unit test for the Elastic\AppSearch\Model\Adapter\Engine\Schema\CompositeSchemaProvider class.
 *
...
class CompositeSchemaProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function getSchemaBuilder()
    {
        ...
        $schemaFactory = $this->createMock('Elastic\AppSearch\Model\Adapter\Engine\SchemaInterfaceFactory');
